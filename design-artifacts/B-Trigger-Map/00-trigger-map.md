# Trigger Map: University AI Compute Management Platform
...
## Known Stakeholder Groups (from Phase 0 intake)

Starting point for Target Groups workshop — validate and expand through conversation, don't treat as final:

- **Academic Administration** — fair, policy-aligned governance and auditability, no financial chargebacks/billing
- **Teachers** — absolute guarantee that scheduled class GPU capacity is protected from general use
- **Students** — transparency, clear denial reasons (rule/quota/unavailability/reservation conflict)
- **Lab Operators** — real-time operational visibility into machine health, occupancy, failures
- **Privileged Users / Researchers** — controlled permission paths for high-VRAM and distributed-training jobs

**Key tensions to explore:** GPU resource scarcity; friction between ad-hoc student access and strict class reservation windows; eliminating current informal/manual coordination.
